                ...
                <div className="header__wrapper">
                    <div className="header__block">
                        ...
                        <form className="header__form" onSubmit={(e) => e.preventDefault()}>
                            ...
                            {options && (
                                <>
                                    <div style={options.length > 0 && showResults ? {display: 'block'} : {}} className="header__search-close" onClick={handleCloseClick}>
