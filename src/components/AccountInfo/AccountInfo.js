                ...
                <div className="account-container">
                    ...
                    <div className="account-info">
                        ...
                        <div className="account-data">
                            ...
                            <button disabled={!canUpload} className="account__add-video-btn">
                                ...
                                <div className="account__form-cover">
                                    <div className="account__upload-video">
                                        <label className="account__upload-video-label">
                                            ...
                                            <div className="account__for-upload" style={video ? {display: 'none'} : {}}>
                                    ...
                                    <div className="account__form-info">
                                        ...
                                        <div className="account-form__radios">
                                            <label className="account-form__label-check">
                                                <input value={acceptRules} onChange={toggleAcceptRules} className="account-form__check-input" type="checkbox"/>
                                            ...
                                            <label className="account-form__label-check">
                                                <input value={acceptPrivacyPolicy} onChange={toggleAcceptPrivacyPolicy} className="account-form__check-input" type="checkbox"/>
                                                <span className="account-form__checkmark"></span>
                                                <p>
