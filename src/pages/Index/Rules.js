            ...
            <ul className="roules__list">
              <li className="roules__item">
                <div className="roules__img">
                  <picture>
                    <source srcSet={rule1} media="(min-width: 651px)" />
              ...
              <li className="roules__item">
                <div className="roules__img">
                  <picture>
                    <source srcSet={rule2} media="(min-width: 651px)" />
              ...
              <li className="roules__item">
                <div className="roules__img">
                  <picture>
                    <source srcSet={rule3} media="(min-width: 651px)" />
                ...
                <div className="roules__roulet__item-flex">
                  ...
                  <div className="roules__item-text">
                    Отправьте ссылку на видео друзьям и попросите голосовать за
                    вас
                  </div>
                </div>
              </li>
              <li className="roules__item">
                <div className="roules__absolute-block">
                  Заявки и голоса принимаются <br />с 9.09.2024 по 29.09.2024
                </div>
                <div className="roules__img">
                  <picture>
                    <source srcSet={rule4} media="(min-width: 651px)" />
                ...
                <div className="roules__roulet__item-flex">
                  ...
                  <div className="roules__item-text">
                    Собирайте лайки от зрителей со всей страны и ждите
